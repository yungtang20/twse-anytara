insert into public.trading_calendar (date, is_open, source)
select distinct date, true, 'stock_price_backfill'
...
comment on function public.enforce_cloud_retention(integer, integer, integer, boolean) is
  'Deletes market rows before the shared 512-date cutoff using trading_calendar.';
